...
from ..ur5_manipulation import UR5BaseEnv, UR5BaseEnvCfg
from ..reward_utils.reward_utils import *

@configclass
class UR5LiftEnvCfg(UR5BaseEnvCfg):
    episode_length_s = 10.0
    use_visual_obs = False
    use_visual_marker = False
    observation_space = [3, 64, 64] if use_visual_obs else 27

class UR5LiftEnv(UR5BaseEnv):
    cfg: UR5LiftEnvCfg

    def __init__(self, cfg: UR5LiftEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _check_success(self) -> torch.Tensor:
        ...
        return target_height>table_height + 0.05
